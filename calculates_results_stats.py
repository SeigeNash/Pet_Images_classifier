...
def calculates_results_stats(results_dic):
    ...
    results_dic_key = list(results_dic.keys())
    ...
    for i in results_dic_key:
        try:
            # condition for Number of Correct Dog matches
            if results_dic[i][3] == 1 and results_dic[i][4] == 1:
                n_correct_dogs += 1
            # condition for Number of Dogs
            if results_dic[i][3] == 1:
                n_dogs_img += 1
            # condition for Number of Correct Non-Dog match
            if results_dic[i][3] == 0 and results_dic[i][4] == 0:
                n_correct_notdogs += 1
            # condition for Number of Not Dog Images
            if results_dic[i][3] == 0:
                n_notdogs_img += 1
            # condition for Number of Correct Breed matches
    ...
    # what i have predicted here is percentage of dogs, non dogs and correct breeds
